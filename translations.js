const translations = {
    'en': {
        ...
        'service1_feature1': 'Set up customization',
        'service1_feature2': 'WordPress Help',
        'service2_title': 'Server Purchase Help',
        'service2_desc': 'Choose and recommend some server. Choose the most valuable one for you.',
        'service2_price': '$50 for a 20-min session',
        'service2_feature1': 'Well-prepared for your needs',
        'service2_feature2': 'Cost-effective recommendations',
    ...
    'zh-HK': {
        ...
        'service2_title': '伺服器選購諮詢',
        'service2_desc': '為你揀選同推薦最合適嘅伺服器。',
        'service2_price': '20分鐘 USD$50',
        'service2_feature1': '為你嘅需求做好準備',
        'service2_feature2': '性價比推薦',
        'btn_get_started': '開始',
    ...
    'zh-TW': {
        ...
        'service1_price': '30分鐘 USD$120',
        'service1_feature1': '客製化設定',
        'service1_feature2': 'WordPress支援',
        'service2_title': '主機選購諮詢',
        'service2_desc': '為您挑選並推薦最適合的主機。',
        'service2_price': '20分鐘 USD$50',
        'service2_feature1': '為您的需求做好準備',
        'service2_feature2': '性價比推薦',
        'btn_get_started': '開始使用',
